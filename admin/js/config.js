    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data['code'] === 1) {
                ...
                layer.msg('拒绝访问', {time: 1000});
            } else {
                layer.msg('未知错误，请联系管理员！', {time: 1000});
            }
        }
    });
}
...
layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'colorpicker', 'slider'], function () {
    ...
    function delreport(id) {
        $.ajax({
            url: "/dmku/?ac=del&type=report&id=" + id, success: function (data) {
            }
        });
    }
    ...
    function delid(id) {
        $.ajax({
            url: "/dmku/?ac=del&type=list&id=" + id, success: function (data) {
            }
        });
    }
});
